...
public interface BoardMapper {
	...
	//게시물 이전 보기
	public int pre_seqno(Map<String,Object> map) throws Exception;
	
	//게시물 다음 보기
	public int next_seqno(Map<String,Object> map) throws Exception;
	...
	//좋아요/싫어요 확인 가져 오기
	public LikeVO likeCheckView(Map<String,Object> map) throws Exception;
	
	//좋아요/싫어요 갯수 수정하기
	public void boardLikeUpdate(Map<String,Integer> map) throws Exception;
